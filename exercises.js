...
function sumArray(numbers, cb) {
	var number = numbers.reduce(function(a,b){
		return a+b;});
		cb(number);//sum up all of the integers in the numbers array
...
function addPrototypeMethod(Constructor) {
	Constructor.prototype.sayHi=function(){return 'Hello World!';};//add a method to the constructor's prototype
